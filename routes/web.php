...
Route::get('posts/{id}/edit', [PostController::class, 'edit'])->name('posts.edit'); // ✅ Added edit route
Route::put('posts/{id}', [PostController::class, 'update'])->name('posts.update'); // ✅ Separate update route
